...
public class PlayMathLevel1Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_play_math_level1);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                try {
                    ...
                    error = true;
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(PlayMathLevel1Activity.this);
                ...
                if (!error) {
                    ...
                    Toast.makeText(PlayMathLevel1Activity.this, "Votre score : " + score + "/9", Toast.LENGTH_LONG).show();
                }
            }
        });
